...
while(True): 
    ...
    for entry in feed.entries:
        ...
        updated_year, updated_month, updated_day = list(map(int, entry.updated.split('T')[0].split('-')))
        print('Last update year, month, date:  %i %i %i' % (updated_year, updated_month, updated_day))
